...
const btn_stepen=document.querySelector(".btn_stepen")
const btn_factorail=document.querySelector(".btn_factorial")
let first_number = 0;
let operation = "";
let key_operation = "";
let count_dot = 0;
...
function calculator() {
  ...
  //2 функции дз
  btn_stepen.addEventListener("click",()=>{
    first_number=input.value
    input.value=(first_number*first_number)
  })
  btn_factorail.addEventListener("click",()=>{
    first_number=input.value
    let b=1
